...
<body>
	<div class="container">
		...
		<div class="row">
			<div class="col-6">
				<form:form action="showDetails" modelAttribute="account" cssClass="form-horizontal" role="form">
					...
					<div class="form-group row">
						<Label for="adhaarId" class="col-6 col-form-label"> Identity:</Label>
						<div class="col-6">
							<form:input path="adhaarId" cssClass="form-control" />
							<form:errors path="adhaarId" cssClass="alert-danger" />
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						<Label for="address" class="col-6 col-form-label">Gender :</Label>
						<div class="col-6">
					...
					<div class="form-group row">
						<Label for="address" class="col-6 col-form-label"> Address:</Label>
						<div class="col-6">
					...
					<div class="form-group row">
						<Label for="vkCode" class="col-6 col-form-label"> V K Bank Code</Label>
						<div class="col-6">
							<form:input path="vkCode" cssClass="form-control" />
							<form:errors path="vkCode" cssClass="alert-danger" />
						</div>
					</div>
					<div class="form-group row">
