...
<title>V K Bank Search Account Details:</title>
</head>
<body>
	<div class="container">
		...
		<div class="row">
			...
			<form:form cssClass="form-horizontal" role="form" id="accForm">
				<div class="form-group row">
					<Label for="accountNo" class="col-2 col-form-label">Account No:</Label>
					<div class="col-8" >
					<input type="text" class="form-control" placeholder="Enter Account No" name="accountNo" id="accountNo" />
					</div>
					<div class="col-2">
	...
	function searchViaAjax(){
		...
		$.ajax({
			...
			url:"http://localhost:8085/PSBankApp/account",
	...
	function display(data){
		...
		$('#vkCode').html("Security Code :" +data["vkCode"]);
		$('#divError').hide();
		$('#divResults').show();
	}
	</script>
